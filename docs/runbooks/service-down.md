...
- Monitor Uptime Kuma rouge sur `https://<LUMIA_DOMAIN>/api/health`
...
# 1. État des conteneurs — lequel est down / unhealthy ?
...
```bash
curl -s https://<LUMIA_DOMAIN>/api/health   # {"status":"ok",...}
