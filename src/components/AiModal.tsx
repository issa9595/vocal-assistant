...
/**
 * Composant MicrophoneButton
 * 
 * Gros bouton rond pour activer/désactiver la reconnaissance vocale.
 * Change d'apparence selon l'état (idle, listening, etc.)
 */
function MicrophoneButton({ status, isSupported, onClick }: MicrophoneButtonProps) {
  ...
  return (
    ...
    >
      {/* Cercles d'animation quand en écoute */}
      {isListening && (
        <>
          <span
            className="
